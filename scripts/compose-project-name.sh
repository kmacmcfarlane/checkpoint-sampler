...
#
# Examples:
#   ./scripts/compose-project-name.sh checkpoint-sampler-dev
#     -> checkpoint-sampler-dev                (main checkout)
#     -> checkpoint-sampler-dev-s-042          (worktree for S-042)
#
#   ./scripts/compose-project-name.sh checkpoint-sampler-test
#     -> checkpoint-sampler-test               (main checkout)
#     -> checkpoint-sampler-test-s-042         (worktree for S-042)
#
